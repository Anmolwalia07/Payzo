...
<form
  ...
  ">
      ...
      <h2 className="text-2xl mt-1 flex justify-center">Welcome Back Admin !</h2>
      ...
      <button type="submit" className="bg-blue-500 rounded-2xl w-[90%] mb-2 p-2 text-lg text-white mt-3 hover:bg-purple-600 tracking-wider">Next</button>
    </form>
    </div>
    </>
  );
