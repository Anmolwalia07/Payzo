...
export default function Page() {
  ...
  return (
    <div className="w-full mb-5 lg:mb-0">
      <h1 className="text-5xl font-bold text-blue-600 mt-6 ml-6">Add Money</h1>
      <div className="w-full mt-8 pr-3 lg:flex">
        <Moneycomponent user={ctx[0]}  setUser={ctx[1]} text="Add Money"/>
        <div className="w-full lg:w-[50%] px-2 ml-2 mt-2 lg:mt-0 lg:ml-0 lg:px-0">
          <Balance balance={ctx[0].balance} />
          <RecentTransactions recentTransactions={ctx[0].OnRampTransaction.slice(0,2)} text={"Deposit"}/>
        </div>
      </div>
    </div>
  );
