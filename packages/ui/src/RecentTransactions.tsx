...
export default function RecentTransactions({recentTransactions}:{recentTransactions:onRampTransaction[]}){
        ...
        return(
          <li className="list-none w-full border border-gray-300 shadow flex justify-between items-center rounded-lg px-3 py-0.5" key={trans.id}>
            ...
            <div className="w-fit flex flex-col items-center ">
              <h1 className="text-md md:text-xl font-mono font-semibold">Deposits</h1>
              <h1 className="text-xs md:text-md ">{trans.startTime.toUTCString()}</h1>
            </div>
